...
::: {.tldr}
**TLDR.** For many biological age clocks, "age acceleration" is really an age gap. DunedinPACE is closer to age speed. True acceleration is change in that speed over time.
:::
